...
class TetrisGame {
	...
	TetrisGame() {
		shapes[0] = new Shape(4, new int[] {8,9,10,11}, new Color(0,255,255));  // I
		shapes[1] = new Shape(3, new int[] {0,3,4,5}, new Color(0,0,255));    // J
		shapes[2] = new Shape(3, new int[] {2,3,4,5}, new Color(255,165,0));  // L
		shapes[3] = new Shape(2, new int[] {0,1,2,3}, new Color(255,255,0));  // O
		shapes[4] = new Shape(4, new int[] {5,6,8,9}, new Color(0,255,0));   // S
		shapes[5] = new Shape(3, new int[] {1,3,4,5}, new Color(160,32,240)); // T
		shapes[6] = new Shape(4, new int[] {4,5,9,10}, new Color(255,0,0));    // Z
